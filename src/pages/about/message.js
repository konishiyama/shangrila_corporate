    ...
    <>
      <section>
        ...
        >
          ...
          <br></br>
          <BodyText>
            しかし、事業をすすめるなかで、「地域統合」や「平和」といった言葉が、独り歩きしているように感じることが多々、ありました。
            事業の関係で様々な方々にお会いする度に、上記のような内容を意気揚々と語るのですが、皆様両手を上げて大賛成！！！、、、というわけには行きませんでした。「気持ちはわかるけど、絵空事のような気がするなぁ。」といった趣旨のことを言われることもしばしば。
          </BodyText>
          <br></br>
          <BodyText>
            そうした時、出会ったのが上述の学生さんの言葉でした。
            <br></br>
          ...
          <BodyText>
            ...
            そしてそうした人々の行動は、近代の国際情勢が安定化による恩恵を受けつつ、より国境を超えた範囲へと広がることになってきました。その結果、人々は海外旅行という選択肢や、音楽・文学といった海外の文化を楽しんだり、未だ会ったことのない友人との出会いを求め、言語を学習したりするようになりました。
            <br></br>
            そしてまた、これまで中国、台湾、韓国と、それぞれの土地で住み、食べ、遊ぶことを通じてより充実した人生を歩もうとしてきた自分自身もまさに、そうした人々の隊列に参加する一員なのであるということにもまた、改めて気付かされたのです。
          </BodyText>
          <br></br>
          <BodyText>
            地域統合や平和が必要だから、人々が動くのではありません。人々が望むことの結果として、地域の連携や、地域的な平和を、時代が、人々が求める時が訪れるのではないでしょうか。
            <br></br>
            そして私達は、そうして自由に、人生を楽しもうとする人々のサポートをすることを通じ、新たな時代を形つくって行くことができるような存在の一角となりたい、といった想いから、日々、事業に取り組んでいます。
          </BodyText>
          <br></br>
          <BodyText>
